...
def perform_speed_test(filename, interval_seconds, index_last):
    ...
    # Automate speedtest at CMD/Powershell and store the outputs
    # Uncomment based on the environment to execute the speedtest
    os.system('cmd /c "speedtest --secure > results.txt" ')             # Execute speedtest in CMD
    # os.system('speedtest --secure > results.txt')                       # Execute speedtest in Powershell
